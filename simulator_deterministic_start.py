...
class SimulatorDeterministicStart:
    ...
    def newGame(self, tgt_y, tgt_x, episodes):
        # 0. setting up
        ...
        self.obj_pos[self.bot_ind][0] = self.fre_pos[episodes][0]
        self.obj_pos[self.bot_ind][1] = self.fre_pos[episodes][1]
        # 3. wrap up
        self.draw_new()
        self.tgt_pos_old[0] = self.obj_pos[self.tgt_ind][0]
        self.tgt_pos_old[1] = self.obj_pos[self.tgt_ind][1]
